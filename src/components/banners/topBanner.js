...
export const TopBanner = () => {
    ...
    return (
        <div className="absolute flex top-3 left-1/2 -translate-x-1/2 w-2/5 h-14 pr-10 pl-10 bg-gray-300 rounded-full z-10 shadow-lg" 
            style={show ? {transition : "1s", transform : "translateY(0%) translateX(-50%)"} : {transition : "1s", transform : "translateY(-5rem)  translateX(-50%)"}}>
            <img className='absolute top-0 left-0 w-full h-full rounded-full' src="assets/images/tmpbanner.png" alt="banner"/>
